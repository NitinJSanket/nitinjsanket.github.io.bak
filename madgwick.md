...
$$
{}^{I}_{W}\mathbf{q}_{\omega,t+1} = {}^{I}_{W}\mathbf{q}_{est,t} + {}^{I}_{W}\mathbf{\dot{q}}_{est,t+1}\Delta t $$ <br>
Here, \(\Delta t\) is the time elapsed between two samples at \(t\) and \(t+1\). </center>
